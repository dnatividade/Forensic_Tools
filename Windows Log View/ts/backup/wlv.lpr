...
function ExtractUserNameFromMessage(const Message: string): string;
var
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        Usuario := ExtractUserNameFromMessage(String(FWbemObject.Properties_('Message').Value));
      end
      ...
      begin
        ...
        Writeln(LogFile, Format('"%s","%d","%s"',
          [GetWmiDateTime(WmiToDateTime(String(FWbemObject.TimeGenerated))),
